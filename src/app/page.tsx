...
export default function Home() {
  return (
    ...
    <div className="absolute top-0 w-[220px] md:w-full flex justify-between md:px-[5%] lg:px-[10%]   ">
    <div className=" items-center ">
      <img className="h-6 md:h-12 " src="/logo.png" alt="Logo" />
    </div>
    ...
    <div className=" bg-cover relative mb-10 ">
        ...
        w-80 h-96 z-10
            -bottom-[10%]
            right-[13%]" src="/Image-2.png" alt="img" />
        ...
        <div className=" bg-cover relative z-10  mb-10 ">
          ...
          <div className="absolute top-[5%] mx-56  flex-col text-center ">
          ...
          <div className="absolute -bottom-[6%] mx-52 ">
            <div className="grid grid-flow-col gap-4">
            <div className="shadow-md bg-white rounded-lg pb-3">
